...
public class SecurityConfiguration {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.requestMatchers("/","/home","/loginErrorPage", "/products/**", "/aboutUs", "/suspensionPage").permitAll()
				.requestMatchers("/registerComplete", "/registerFail", "/loginPassConfirm",
						"/suspensionChecker").permitAll()
				.requestMatchers("/consumers/**").hasAuthority("ADMIN")
